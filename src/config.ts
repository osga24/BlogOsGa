...
export const profileConfig: ProfileConfig = {
  avatar: 'assets/images/header.png',  // Relative to the /src directory. Relative to the /public directory if it starts with '/'
  name: 'OsGa',
  bio: 'NYUST / CTF Player',
  links: [
    {
      name: 'Instagram',
      ...
      url: 'https://www.instagram.com/os324_/',
    },
    {
      name: 'Profile Web',
